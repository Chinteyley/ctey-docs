...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/favicon.ico?v=favicon1' },
      { url: '/favicon-16x16.png?v=favicon1', sizes: '16x16', type: 'image/png' },
      { url: '/favicon-32x32.png?v=favicon1', sizes: '32x32', type: 'image/png' },
    ],
    apple: [
      { url: '/apple-touch-icon.png?v=favicon1', sizes: '180x180', type: 'image/png' },
    ],
  },

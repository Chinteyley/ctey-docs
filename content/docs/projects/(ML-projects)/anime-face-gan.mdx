...
The Gradio app lives on Hugging Face Spaces: [Anime Face GAN](https://huggingface.co/spaces/kimteyley/anime-face-gan). Free Spaces sleep after inactivity, so the page may ask you to restart it. There is no public GitHub repository under Chinteyley for this project.
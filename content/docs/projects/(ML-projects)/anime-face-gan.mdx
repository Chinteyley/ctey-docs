...
description: A GAN that generates anime faces. Try it on Hugging Face Spaces.
icon: Laugh
---

## Overview

Anime Face GAN is a small experiment: two networks train against each other until the generator can draw new anime faces from noise. I built it to see how far a GAN would get on a character-art dataset.
...
Try it on Hugging Face Spaces: [Anime Face GAN](https://huggingface.co/spaces/kimteyley/anime-face-gan)